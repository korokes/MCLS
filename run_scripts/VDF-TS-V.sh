...
CUDA_VISIBLE_DEVICES=0 python src/train_s2_apd.py --arch APDVtransformer --data data-bin/how2mcls --train_video_file data/demo_data/train_action.txt --val_video_file data/demo_data/val_action.txt --video_dir data/demo_data/video_action_features --target-dir checkpoints/vdf_s1 --save-dir checkpoints/vdf_s2v 
...
CUDA_VISIBLE_DEVICES=0 python src/generate.py --data data-bin/how2mcls --video_file data/demo_data/test_action.txt  --video_dir data/demo_data/video_action_features --checkpoint-path checkpoints/vdf_s3v/checkpoint_last.pt > vdf_ts_v.out
