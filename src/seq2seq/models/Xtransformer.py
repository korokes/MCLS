...
from seq2seq.modules import MultiheadAttention, LearnedPositionalEmbedding
...
class XTransformerModel(Seq2SeqModel):
    ...
    def build_model(cls, args, all_en_dict, src_pt_dict):
        ...
        decoder = TransformerDecoder(args, all_en_dict, tgt_embed_tokens)
        return XTransformerModel(encoder, decoder)
