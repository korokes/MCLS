...
@register_model('LAWDtransformer')
class LAWDTransformerModel(Source2TargetModel):
    ...
    def build_model(cls, args, all_en_dict, src_pt_dict):
        ...
        source_encoder = LAWDTransformerEncoder(args, src_pt_dict, src_embed_tokens)
        target_encoder = TransformerEncoder(args, all_en_dict, shared_embed_tokens)
        return LAWDTransformerModel(source_encoder, target_encoder)


class LAWDTransformerEncoder(Seq2SeqEncoder):
...
@register_model_architecture('LAWDtransformer', 'LAWDtransformer')
