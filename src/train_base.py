...
def get_args():
    ...
    parser.add_argument('--log-file', default='./log_dir/log_base.txt', help='path to save logs') 
    parser.add_argument('--save-dir', default='checkpoints/model_base', help='path to save checkpoints') 
    parser.add_argument('--restore-file', default='checkpoint_last.pt', help='filename to load checkpoint')
    parser.add_argument('--pretrained_path', default='', help='filename to load checkpoint')
