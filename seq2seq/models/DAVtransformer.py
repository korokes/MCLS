...
@register_model('DAVtransformer')
class DAVTransformerModel(Source2TargetModel):
    ...
    def build_model(cls, args, all_en_dict, src_pt_dict):
        ...
        source_encoder = DAVTransformerEncoder(args, src_pt_dict, src_embed_tokens)
        target_encoder = TransformerEncoder(args, all_en_dict, shared_embed_tokens)
        return DAVTransformerModel(source_encoder, target_encoder)


class DAVTransformerEncoder(Seq2SeqEncoder):
...
@register_model_architecture('DAVtransformer', 'DAVtransformer')
