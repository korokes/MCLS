...
from .model import Seq2SeqModel, Seq2SeqEncoder, Seq2SeqDecoder, MMSeq2SeqModel, Source2TargetModel
...
def build_model(args, all_en_dict, src_pt_dict):
    return ARCH_MODEL_REGISTRY[args.arch].build_model(args, all_en_dict, src_pt_dict)
...
def register_model(name):
    ...
    def register_model_cls(cls):
        ...
        if not (issubclass(cls, Seq2SeqModel) or issubclass(cls, MMSeq2SeqModel) or issubclass(cls, Source2TargetModel)):
